...
三步
第一步添加文件  (build setting 下搜索header searche)添加-> (/usr/include/libxml2)
第二步添加文件   (build setting 下搜索other linker)添加->(-lxml2)
第三步添加文件  (build phases 下搜索 GDataXMLNode.m)添加->  (-fno-objc-arc)
